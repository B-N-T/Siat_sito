...
function fburger(){
	if(c%2===0){
		...
		// anime({											//animazione freccie1 della tendina all'apertura
  // 			targets: frecciaTendina1,
  // 			opacity: 1,
  ...
  // 			delay: function(el, i) { return i * 250 }
		...
		// anime({											//animazione freccie2 della tendina all'apertura
  // 			targets: frecciaTendina2,
  // 			opacity: 1,
  // 			strokeDashoffset: [anime.setDashoffset, 0],
  // 			easing: 'easeInOutSine',
  // 			duration: 500,
